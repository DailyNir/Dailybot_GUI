...
class CutterWindow(customtkinter.CTkToplevel):
    def __init__(self, *args, **kwargs):
        super().__init__(*args, **kwargs)
        self.geometry("600x1000")
        self.title("Cutter Controller")
        ...
        self.label = customtkinter.CTkLabel(self, text="Xarm6 Cutter Controller")
        self.label.grid(row=0, column=1, padx=20, pady=10)
        self.label.grid_columnconfigure(1, weight=1)
        self.connect_to_gripper=customtkinter.CTkButton(self, text="Connect to Cutter", command=self.plus_z_event,width=100)
        ...
        self.open_gripper_buttom=customtkinter.CTkButton( self.controls_frame, text="Cutter Safety Off", command=self.cutter_safety_off,width=100)
        self.open_gripper_buttom.grid(row=2, column=0, padx=20, pady=10)
        self.close_gripper_buttom=customtkinter.CTkButton( self.controls_frame, text="Cut", command=self.cut,width=100)
